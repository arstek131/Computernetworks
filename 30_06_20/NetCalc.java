...
public class NetCalc
{
	...
	static public String ipAsString(int[] ip) {
		assert ip.length == 4;
	...
	public String getNetmask() {
		return ipAsString(calcolaNetmask(n));
	}

	public String getNetId() {
		return ipAsString(calcolaNetid(parseIp(ip), calcolaNetmask(n)));
	}

	public String getNumHost() {
		return String.valueOf(calcolaNumHost(n));
	}
}
